//https://github.com/WeActStudio/WeActStudio.EpaperModule/blob/master/Example/EpaperModuleTest_APM32F103/Epaper/epaper.c
...
// 2.13'' EPD Module
// antes GxEPD2_BW<GxEPD2_213_BN, GxEPD2_213_BN::HEIGHT> display(GxEPD2_213_BN(/*CS=5*/ 5, /*DC=*/ 0, /*RST=*/ 2, /*BUSY=*/ 15)); // DEPG0213BN 122x250, SSD1680
GxEPD2_BW<GxEPD2_213_BN, GxEPD2_213_BN::HEIGHT> display(GxEPD2_213_BN(/*CS=5*/ 5, /*DC=*/ 22, /*RST=*/ 21, /*BUSY=*/ 4)); // DEPG0213BN 122x250, SSD1680
...
const char HelloWorld[] = "Hello Joaquin!";
